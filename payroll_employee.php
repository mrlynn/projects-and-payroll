...
<META HTTP-EQUIV="CACHE-CONTROL" CONTENT="NO-CACHE">
	<title id=page-title>Payroll Reporting</title>
	<link rel="stylesheet" href="css/custom.css" />
	<link rel="stylesheet" href="css/page.css" />
	<link rel="stylesheet" href="css/calendar.css" />
	<link rel="stylesheet" href="css/PrinterFriendly.css" />
	...
	<script type="text/javascript" src="js/PrinterFriendly.js"></script>
	<script type="text/javascript" src="js/WSSGrid.js"></script>
	<script type="text/javascript" src="js/payroll_employee.js"></script>
    <style type="text/css">
        .x-grid3-cell-inner {

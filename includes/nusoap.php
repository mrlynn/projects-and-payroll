...
class nusoapclient extends nusoap_base  {
	...
	*/
	function call($operation,$params=array(),$namespace='http://tempuri.org',$soapAction='',$headers=false,$rpcParams=null,$style='rpc',$use='encoded'){
		return $this->specialcall($operation,$params,'',$namespace,$soapAction,$headers,$rpcParams,$style,$use);
	}
	function specialcall($operation,$params=array(),$specialmsg='',$namespace='http://tempuri.org',$soapAction='',$headers=false,$rpcParams=null,$style='rpc',$use='encoded'){
...
//			$use = isset($opData['use']) ? $opData['use'] : $use;
			// add ns to ns array

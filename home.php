...
<div id="admin-details">
    ...
    <p>Use <b>Table Administration</b> to create and maintain important settings which control how the system works. <p id='caution'>EXERCISE EXTREME CAUTION WHEN EDITING THESE SETTINGS</p>
</div>
